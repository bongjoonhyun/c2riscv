...
00010280 <_start>:
   ...
   102a0:	0f868693          	addi	a3,a3,248 # 10394 <__libc_csu_init>
   102a4:	00000717          	auipc	a4,0x0
   102a8:	18070713          	addi	a4,a4,384 # 10424 <__libc_csu_fini>
...
0001035c <main>:
   ...
   10368:	3e800793          	li	a5,1000
   1036c:	fef42623          	sw	a5,-20(s0)
   10370:	00300793          	li	a5,3
   10374:	fef42423          	sw	a5,-24(s0)
   10378:	fec42703          	lw	a4,-20(s0)
   1037c:	fe842783          	lw	a5,-24(s0)
   10380:	02f707b3          	mul	a5,a4,a5
   10384:	00078513          	mv	a0,a5
   10388:	01c12403          	lw	s0,28(sp)
   1038c:	02010113          	addi	sp,sp,32
   10390:	00008067          	ret

00010394 <__libc_csu_init>:
   10394:	fe010113          	addi	sp,sp,-32
   10398:	00812c23          	sw	s0,24(sp)
   1039c:	01212823          	sw	s2,16(sp)
   103a0:	00002417          	auipc	s0,0x2
   103a4:	b6840413          	addi	s0,s0,-1176 # 11f08 <__frame_dummy_init_array_entry>
   103a8:	00002917          	auipc	s2,0x2
   103ac:	b6490913          	addi	s2,s2,-1180 # 11f0c <__do_global_dtors_aux_fini_array_entry>
   103b0:	40890933          	sub	s2,s2,s0
   103b4:	00112e23          	sw	ra,28(sp)
   103b8:	00912a23          	sw	s1,20(sp)
   103bc:	01312623          	sw	s3,12(sp)
   103c0:	01412423          	sw	s4,8(sp)
   103c4:	01512223          	sw	s5,4(sp)
   103c8:	40295913          	srai	s2,s2,0x2
   103cc:	02090a63          	beqz	s2,10400 <__libc_csu_init+0x6c>
   103d0:	00050993          	mv	s3,a0
   103d4:	00058a13          	mv	s4,a1
   103d8:	00060a93          	mv	s5,a2
   103dc:	00000493          	li	s1,0
   103e0:	00042783          	lw	a5,0(s0)
   103e4:	000a8613          	mv	a2,s5
   103e8:	000a0593          	mv	a1,s4
   103ec:	00098513          	mv	a0,s3
   103f0:	00148493          	addi	s1,s1,1
   103f4:	000780e7          	jalr	a5 # 12000 <__TMC_END__>
   103f8:	00440413          	addi	s0,s0,4
   103fc:	fe9912e3          	bne	s2,s1,103e0 <__libc_csu_init+0x4c>
   10400:	01c12083          	lw	ra,28(sp)
   10404:	01812403          	lw	s0,24(sp)
   10408:	01412483          	lw	s1,20(sp)
   1040c:	01012903          	lw	s2,16(sp)
   10410:	00c12983          	lw	s3,12(sp)
   10414:	00812a03          	lw	s4,8(sp)
   10418:	00412a83          	lw	s5,4(sp)
   1041c:	02010113          	addi	sp,sp,32
   10420:	00008067          	ret

00010424 <__libc_csu_fini>:
   10424:	00008067          	ret
